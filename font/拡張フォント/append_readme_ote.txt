...
この度は、拡張チェックアンドU-Foフォントをダウンロードしていただき、
ありがとうございます。



1. 拡張チェックアンドU-Foフォントとは
拡張チェックアンドU-Foフォントは、
チェックアンドU-Foフォント（圧縮ファイル同封）の字形を
文字通り「拡張」するフォントです。

フォント制作における制約上、
これまで「メイン（＝チェックアンドU-Foフォント）」の
フォントファイルに収録しようとしても、できなかった漢字たち。
それらを救済すべく、拡張チェックアンドU-Foフォントはメインに対する
...
チェックアンドU-Foフォントと併せてインストールしていただき、
...
2014/01/13	Version 1.001	・10字（ガ行鼻濁音を示す
				　ひらがな5字、カタカナ5字）を修正
